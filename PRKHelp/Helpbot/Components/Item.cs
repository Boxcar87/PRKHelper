    ...
    public class Item : Component
    {
        ...
        public override int Process(string[] _params)
        {
            ...
            foreach (AOItem item in items)
            {
                ...
                if(item.type == 1)
                    OutputStrings[page] += $"Add to DPM Planner <a href='chatcmd:///character plan mainhand raw {item.lowid} {localQl}'>[Mainhand]</a>|<a href='chatcmd:///character plan mainhand raw {item.lowid} {localQl}'>[Offhand]</a><br>";
