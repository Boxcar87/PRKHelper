...
Drag and drop item into chat and get reasonably close pricing. Some items have unknown special price reduction metrics. Be sure to update your characters complit first (/character complit 123)
### /vendor (drop item)
