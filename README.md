...
The commands are sent via /whisper which has a very low range so conflicting messages between users are highly unlikely. The results themselves are echod to you so only you can see them. 
