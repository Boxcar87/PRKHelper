If you run into bugs or issues please make a note of them here. The way the bot will "break" is that it will regurgitate your previous script output instead of generating a new one.
